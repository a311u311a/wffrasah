...
class _AdminCarouselScreenState extends State<AdminCarouselScreen> {
  ...
  Future<void> _deleteItem(String id) async {
    try {
      ...
      if (mounted) showSnackBar(context, 'تم حذف البنر بنجاح');
    } catch (e) {
                          ...
                          : () async {
                              ...
                              if (url != null) {
                                try {
                                  ...
                                  if (mounted)
                                    showSnackBar(ctx, 'خطأ في الحفظ: $e',
                                        isError: true);
                                }
                              } else {
                                setStateSheet(() => isSaving = false);
                      ...
                      onPressed: isSaving
                          ...
                          : () async {
                              ...
                              try {
                                ...
                                setStateSheet(() => isSaving = false);
                                if (mounted)
                                  showSnackBar(ctx, 'خطأ في التحديث: $e',
                                      isError: true);
                              }
                            },
                      child: isSaving
