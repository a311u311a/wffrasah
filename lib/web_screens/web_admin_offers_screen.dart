    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'إضافة، تعديل، أو حذف العروض الخاصة',
            style: TextStyle(
              fontSize: 18,
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'يمكنك استخدام تطبيق الموبايل لإدارة العروض حالياً',
                  style: TextStyle(
                    fontSize: 16,
                    color: Colors.grey[700],
                    fontFamily: 'Tajawal',
